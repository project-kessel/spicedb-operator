...
|---------|--------|--------|-------------|
| `.github/dependabot.yml` | Intervals changed to daily | Aligns with other Kessel Services | Keep ours |
| `.github/renovate.json` | Added our own config | Configures Mintmaker (part of Konflux) to prevent Go pkg update PRs and move to weekly updates for Dockerfile base image updates | Red Hat only |
